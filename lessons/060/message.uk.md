...
*Нові конструкції:*
\- _cuando_ \(when\) — коли
\- _esperar_ \(to wait, to hope\) — чекати або сподіватися; спорідненість з _desperate_ \(unhoped\)
...
Далі: У наступному уроці розберемо, як взаємодіють лінія минулого часу \(тривала дія\) і точка минулого часу \(завершена дія\) у типових конструкціях\.
